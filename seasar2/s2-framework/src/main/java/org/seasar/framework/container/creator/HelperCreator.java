...
/**
 * Helperクラス用の {@link ComponentCreator}です。
 * <p>
 ...
 * <tr>
 * <th>サフィックス</th>
 * <td>{@link NamingConvention#getHelperSuffix() Helper(デフォルト)}</td>
 * </tr>
 * <tr>
 * <th>インスタンス定義</th>
 * <td>prototype</td>
...
public class HelperCreator extends ComponentCreatorImpl {
    ...
    /**
     * 指定された{@link NamingConvention 命名規約}に従った{@link HelperCreator}を作成します。
     * 
