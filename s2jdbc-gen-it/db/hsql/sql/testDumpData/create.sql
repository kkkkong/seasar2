...
create table BIG_DECIMAL_ENTITY (BIG_DECIMAL_PROPERTY decimal);
create table BIG_INTEGER_ENTITY (BIG_INTEGER_PROPERTY bigint);
create table BOOLEAN_ENTITY (BOOLEAN_PROPERTY boolean);
create table BYTE_ARRAY_ENTITY (BYTE_ARRAY_PROPERTY varbinary(255), BLOB_PROPERTY longvarbinary);
...
create table SERIALIZABLE_ENTITY (SERIALIZABLE_PROPERTY varbinary(255), BLOB_PROPERTY longvarbinary);
create table SHORT_ENTITY (SHORT_PROPERTY smallint);
create table SQL_DATE_ENTITY (SQL_DATE_PROPERTY date);
create table STRING_ENTITY (STRING_PROPERTY varchar(255), CLOB_PROPERTY longvarchar);
