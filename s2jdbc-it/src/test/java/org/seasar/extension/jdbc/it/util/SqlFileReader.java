...
import org.seasar.extension.jdbc.it.util.Dialect.SqlBlockContext;
import org.seasar.extension.jdbc.it.util.SqlFileTokenizer.TokenType;
...
public class SqlFileReader {
    ...
    public SqlFileReader(File sqlFile, String sqlFileEncoding,
            SqlFileTokenizer tokenizer, Dialect dialect) {
        if (sqlFile == null) {
