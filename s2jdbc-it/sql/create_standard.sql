...
CREATE TABLE LARGE_OBJECT(ID NUMERIC(8) NOT NULL PRIMARY KEY, NAME VARCHAR(20), LARGE_NAME CLOB, BYTES VARCHAR(1000) FOR BIT DATA, LARGE_BYTES BLOB, DTO VARCHAR(1000) FOR BIT DATA, LARGE_DTO BLOB);
...
CREATE TABLE AUTO_STRATEGY(ID INTEGER NOT NULL PRIMARY KEY, VALUE VARCHAR(10));
...
INSERT INTO ID_GENERATOR VALUES('AUTO_STRATEGY_ID', 1);
