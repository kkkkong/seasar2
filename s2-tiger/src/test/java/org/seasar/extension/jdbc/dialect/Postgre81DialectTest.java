...
import static org.seasar.framework.util.tiger.Pair.*;
...
public class Postgre81DialectTest extends TestCase {
    ...
    public void testGetForUpdateString() {
        ...
        assertEquals(" for update of aaa nowait", dialect.getForUpdateString(
                SelectForUpdateType.NOWAIT, 0, pair("aaa", "a")));
    }
}
